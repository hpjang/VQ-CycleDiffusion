...
parser = argparse.ArgumentParser(description="Initialize the universal codebook")
...
for size in codebook_size:
    ...
    # 저장
    os.makedirs('log/codebook_stock_255_exclude/global', exist_ok=True)
    torch.save(vq.state_dict(), f'log/codebook_stock_255_exclude/global/codebook_stock_{size}.pt')
